...
CREATE INDEX IF NOT EXISTS idx_project_types_code
    ON project_master.project_types(code);

CREATE INDEX IF NOT EXISTS idx_project_types_active
    ON project_master.project_types(is_active);
...
CREATE INDEX IF NOT EXISTS idx_status_definitions_project_type
    ON project_master.status_definitions(project_type_id);
...
CREATE INDEX IF NOT EXISTS idx_tenant_project_extensions_tenant
    ON project_master.tenant_project_extensions(tenant_id);

CREATE INDEX IF NOT EXISTS idx_tenant_project_extensions_status
    ON project_master.tenant_project_extensions(status_definition_id);
