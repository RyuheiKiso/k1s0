...
class _TenantExtensionScreenState
          ...
          children: [
            ...
            Expanded(
              child: extensionAsync.when(
                ...
                data: (extension) {
                  if (extension == null && _currentItemId == null) {
                    return const Center(
                      child: Text('アイテムIDを入力して検索してください'),
                    );
                  }
  ...
  void _loadExtension() {
    ...
    ref
        ...
        .load(widget.tenantId, itemId);
  }

  /// テナント拡張の詳細表示・編集フォームを構築する
  Widget _buildExtensionDetail(TenantMasterExtension extension) {
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildInfoRow('アイテムID', extension.itemId),
                  _buildInfoRow(
                    '表示名オーバーライド',
                ...
                children: [
                  ...
                  TextField(
                    controller: _attributesController
                      ..text = extension.attributesOverride?.toString() ?? '',
                    decoration: const InputDecoration(
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      OutlinedButton(
                        ...
                        onPressed: () =>
                            _deleteExtension(extension.itemId),
                        child: const Text('削除'),
                      ),
                      const SizedBox(width: 8),
                      ...
                      FilledButton(
                        onPressed: () =>
                            _updateExtension(extension.itemId),
                        child: const Text('更新'),
                      ),
                    ],
                  ),
  ...
  /// テナント拡張情報を更新する
  void _updateExtension(String itemId) {
    ...
    ref
        .read(tenantExtensionProvider.notifier)
        .update(widget.tenantId, itemId, input);
  ...
  void _deleteExtension(String itemId) {
    showDialog(
      context: context,
        ...
        actions: [
          ...
          FilledButton(
            onPressed: () {
              ...
              ref.read(tenantExtensionProvider.notifier).update(
                    widget.tenantId,
                    _currentItemId!,
                    input,
                  );
