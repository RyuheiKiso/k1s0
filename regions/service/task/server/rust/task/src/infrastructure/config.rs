...
impl DatabaseConfig {
    ...
    pub fn migrations_path() -> &'static Path {
        Path::new("database/postgres/migrations")
    }
}
...
impl Default for TraceConfig {
    fn default() -> Self {
        Self { enabled: default_trace_enabled(), endpoint: default_trace_endpoint(), sample_rate: default_sample_rate() }
    }
}
