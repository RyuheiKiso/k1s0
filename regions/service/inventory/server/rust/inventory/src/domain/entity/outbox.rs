...
mod tests {
    ...
    fn test_outbox_event_creation() {
        ...
        assert_eq!(event.aggregate_type, "inventory");
    }
    ...
    fn test_outbox_event_serialization_roundtrip() {
        let event = OutboxEvent {
            id: Uuid::new_v4(),
            aggregate_type: "inventory".to_string(),
            aggregate_id: "INV-001".to_string(),
            event_type: "inventory.reserved".to_string(),
        ...
        assert_eq!(deserialized.aggregate_id, "INV-001");
        assert_eq!(deserialized.event_type, "inventory.reserved");
    }
}
