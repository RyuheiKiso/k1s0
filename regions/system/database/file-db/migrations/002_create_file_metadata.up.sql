...
CREATE INDEX IF NOT EXISTS idx_file_metadata_filename ON file_storage.file_metadata (filename);
CREATE INDEX IF NOT EXISTS idx_file_metadata_content_type ON file_storage.file_metadata (content_type);
CREATE INDEX IF NOT EXISTS idx_file_metadata_status ON file_storage.file_metadata (status);
CREATE INDEX IF NOT EXISTS idx_file_metadata_uploaded_by ON file_storage.file_metadata (uploaded_by);
