...
-- policies・policy_bundles の 2 テーブルに適用する
BEGIN;

-- policies テーブルの tenant_isolation ポリシーを WITH CHECK 付きで再作成する
...
-- policy_bundles テーブルの tenant_isolation ポリシーを WITH CHECK 付きで再作成する
