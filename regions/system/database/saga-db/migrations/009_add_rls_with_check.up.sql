...
-- saga_states・saga_step_logs の 2 テーブルに適用する
BEGIN;

-- saga_states テーブルの tenant_isolation ポリシーを WITH CHECK 付きで再作成する
...
-- saga_step_logs テーブルの tenant_isolation ポリシーを WITH CHECK 付きで再作成する
