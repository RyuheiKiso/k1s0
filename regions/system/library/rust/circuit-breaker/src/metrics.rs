...
impl CircuitBreakerMetricsRecorder {
    ...
    pub fn snapshot(&self) -> CircuitBreakerMetrics {
        ...
        CircuitBreakerMetrics {
            failure_count: u32::try_from(self.failure_count.load(Ordering::Relaxed)).unwrap_or(u32::MAX),
            success_count: u32::try_from(self.success_count.load(Ordering::Relaxed)).unwrap_or(u32::MAX),
