...
impl ApiRegistryDomainService {
    ...
    fn check_openapi_compatibility(
        ...
        let old: serde_json::Value =
            serde_yaml::from_str(old_content).unwrap_or(serde_json::Value::Null);
        let new_val: serde_json::Value =
            serde_yaml::from_str(new_content).unwrap_or(serde_json::Value::Null);
