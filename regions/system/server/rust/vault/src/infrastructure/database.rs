...
impl DatabaseConfig {
    ...
    /// search_path=vault を設定し、vault スキーマのテーブルに直接アクセスできるようにする。
    pub fn connection_url(&self) -> String {
        format!(
            "postgres://{}:{}@{}:{}/{}?sslmode={}&options=-c search_path%3Dvault,public",
...
mod tests {
    ...
    fn test_connection_url() {
        ...
        assert_eq!(
            ...
            "postgres://app:secret@localhost:5432/k1s0_vault?sslmode=disable&options=-c search_path%3Dvault,public"
        );
    }
...
"#;
        ...
        assert_eq!(config.name, "k1s0_vault");
