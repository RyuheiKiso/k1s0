...
/// read: 参照系、write: 作成・更新・トリガー系、admin: 削除系
...
mod tests {
    ...
    fn maps_grpc_method_to_action() {
        assert_eq!(action_mapper("ListJobs"), "read");
        assert_eq!(action_mapper("DeleteJob"), "admin");
        assert_eq!(action_mapper("CreateJob"), "write");
        assert_eq!(action_mapper("TriggerJob"), "write");
    }
