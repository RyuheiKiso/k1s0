...
/// EvaluateFlagRequest はフィーチャーフラグ評価リクエスト。
...
/// EvaluateFlagResponse はフィーチャーフラグ評価レスポンス。
#[derive(Clone, PartialEq, ::prost::Message)]
...
/// CreateFlagResponse はフラグ作成レスポンス。
#[derive(Clone, PartialEq, ::prost::Message)]
...
/// UpdateFlagResponse はフラグ更新レスポンス。
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct UpdateFlagResponse {
    #[prost(message, optional, tag = "1")]
    pub flag: ::core::option::Option<FeatureFlag>,
}
/// FeatureFlag はフィーチャーフラグ情報。
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub mod feature_flag_service_server {
    ...
    /// FeatureFlagService はフィーチャーフラグの評価・管理を提供する。
    #[derive(Debug)]
                ...
                "/k1s0.system.featureflag.v1.FeatureFlagService/EvaluateFlag" => {
                    ...
                    for EvaluateFlagSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as FeatureFlagService>::evaluate_flag(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/k1s0.system.featureflag.v1.FeatureFlagService/CreateFlag" => {
                    ...
                    for CreateFlagSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as FeatureFlagService>::create_flag(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/k1s0.system.featureflag.v1.FeatureFlagService/UpdateFlag" => {
                    ...
                    for UpdateFlagSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as FeatureFlagService>::update_flag(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
