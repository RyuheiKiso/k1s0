...
/// Application configuration for policy server.
...
mod tests {
    ...
    #[test]
    fn test_opa_config_default_timeout() {
        let yaml = r#"url: "http://opa:8181""#;
        let cfg: OpaConfig = serde_yaml::from_str(yaml).unwrap();
