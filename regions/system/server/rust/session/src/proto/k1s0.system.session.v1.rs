...
/// CreateSessionResponse はセッション作成レスポンス。
#[derive(Clone, PartialEq, ::prost::Message)]
...
/// GetSessionResponse はセッション取得レスポンス。
#[derive(Clone, PartialEq, ::prost::Message)]
...
/// RefreshSessionResponse はセッション更新レスポンス。
#[derive(Clone, PartialEq, ::prost::Message)]
...
/// RevokeSessionResponse はセッション無効化レスポンス。
#[derive(Clone, PartialEq, ::prost::Message)]
...
/// RevokeAllSessionsResponse はユーザーの全セッション無効化レスポンス。
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct RevokeAllSessionsResponse {
    #[prost(uint32, tag = "1")]
    pub revoked_count: u32,
}
/// ListUserSessionsRequest はユーザーセッション一覧リクエスト。
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct ListUserSessionsRequest {
    #[prost(string, tag = "1")]
    pub user_id: ::prost::alloc::string::String,
}
/// ListUserSessionsResponse はユーザーセッション一覧レスポンス。
#[derive(Clone, PartialEq, ::prost::Message)]
...
pub mod session_service_server {
    ...
    pub trait SessionService: std::marker::Send + std::marker::Sync + 'static {
        ...
        ) -> std::result::Result<tonic::Response<super::GetSessionResponse>, tonic::Status>;
        async fn refresh_session(
            &self,
            request: tonic::Request<super::RefreshSessionRequest>,
        ) -> std::result::Result<tonic::Response<super::RefreshSessionResponse>, tonic::Status>;
        ...
        ) -> std::result::Result<tonic::Response<super::RevokeAllSessionsResponse>, tonic::Status>;
        async fn list_user_sessions(
            &self,
            request: tonic::Request<super::ListUserSessionsRequest>,
        ) -> std::result::Result<tonic::Response<super::ListUserSessionsResponse>, tonic::Status>;
    }
    #[derive(Debug)]
                ...
                "/k1s0.system.session.v1.SessionService/RefreshSession" => {
                        ...
                        for RefreshSessionSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SessionService>::refresh_session(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/k1s0.system.session.v1.SessionService/RevokeAllSessions" => {
                        ...
                        for RevokeAllSessionsSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SessionService>::revoke_all_sessions(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/k1s0.system.session.v1.SessionService/ListUserSessions" => {
                        ...
                        for ListUserSessionsSvc<T>
                    {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SessionService>::list_user_sessions(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
