...
.DEFAULT_GOAL := help
.PHONY: help codegen codegen-check openapi openapi-check grpc-docs grpc-docs-check lint pre-commit lint-proto verify verify-quick verify-cones verify-e2e doctor clean
