...
| **file** | S3互換ストレージ統一API・メタデータ管理・プリサインドURL | [server.md](./system/file/server.md) / [db](./system/file/database.md) / [deploy](./system/file/deploy.md) |
...
特定業務領域（accounting 等）内で共通利用する基盤サーバー群。

| サーバー | 用途 | 設計書 |
|---------|------|--------|
| **domain-master** | accounting 領域ドメインマスタデータハブ・テナント別カスタマイズ | [server.md](./business/domain-master/server.md) / [impl](./business/domain-master/implementation.md) / [db](./business/domain-master/database.md) / [deploy](./business/domain-master/deploy.md) |
...
| サーバー | 用途 | 設計書 |
|---------|------|--------|
| **inventory** | 在庫予約・解放・照会・更新・Kafka イベント配信 | [server.md](./service/inventory/server.md) / [db](./service/inventory/database.md) / [deploy](./service/inventory/deploy.md) |
| **order** | 注文作成・照会・ステータス管理・Kafka イベント配信 | [server.md](./service/order/server.md) / [db](./service/order/database.md) / [deploy](./service/order/deploy.md) |
| **payment** | 決済開始・照会・完了・失敗・返金・Kafka イベント配信 | [server.md](./service/payment/server.md) / [db](./service/payment/database.md) / [deploy](./service/payment/deploy.md) |
