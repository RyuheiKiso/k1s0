...
| ドキュメント | 内容 |
| --- | --- |
| [REST-API設計.md](../protocols/REST-API設計.md) | D-007 エラーレスポンス、D-008 バージョニング、D-012 レート制限、D-123 OpenAPI コード自動生成 |
| [gRPC設計.md](../protocols/gRPC設計.md) | D-009 サービス定義パターン、D-010 バージョニング |
| [GraphQL設計.md](../protocols/GraphQL設計.md) | D-011 GraphQL 設計、D-124 実装技術選定 |
...
- [認証認可設計.md](../../auth/design/認証認可設計.md) -- 認証・認可・Kong 認証フロー
...
- [proto設計.md](../protocols/proto設計.md) -- gRPC サービス定義・Protobuf スキーマ・buf 設定
