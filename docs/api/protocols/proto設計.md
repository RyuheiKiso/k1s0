...
API 設計の全体像は [API設計.md](../gateway/API設計.md) D-009 / D-010 を参照。
...
proto パッケージは [API設計.md](../gateway/API設計.md) D-009 の命名規則に従い、メジャーバージョンをパッケージ名に含める。
...
- [API設計.md](../gateway/API設計.md) -- gRPC サービス定義パターン (D-009)・gRPC バージョニング (D-010)
- [system-server設計.md](system-server設計.md) -- auth-server の gRPC サービス定義
- [system-config-server設計.md](../../system-servers/config/server設計.md) -- config-server の gRPC サービス定義
- [認証認可設計.md](../../auth/design/認証認可設計.md) -- JWT Claims 構造・RBAC ロール定義
