...
認証認可設計の全体像は [認証認可設計](認証認可設計.md) を参照。
...
Keycloak テンプレートで使用する変数を以下に示す。変数の定義と導出ルールの詳細は [テンプレートエンジン仕様](テンプレートエンジン仕様.md) を参照。
...
- [認証認可設計](認証認可設計.md) -- 認証・認可の全体設計
- [テンプレートエンジン仕様](テンプレートエンジン仕様.md) -- テンプレート変数・条件分岐・フィルタの仕様
- [テンプレート仕様-Kong](テンプレート仕様-Kong.md) -- Kong テンプレート仕様（認証プラグイン連携）
- [テンプレート仕様-ServiceMesh](テンプレート仕様-ServiceMesh.md) -- ServiceMesh テンプレート仕様（AuthorizationPolicy 連携）
