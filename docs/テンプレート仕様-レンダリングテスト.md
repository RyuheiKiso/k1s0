...
- [テンプレート仕様 — Rust 統合テスト](テンプレート仕様-レンダリングテスト-Rust.md) — ヘルパー関数・テストパターン・スナップショットテスト・命名規則
- [テンプレート仕様 — E2E テスト](テンプレート仕様-レンダリングテスト-E2E.md) — テスト構造パターン・ファイル存在テスト・内容準拠テスト・命名規則
...
| server | csharp | REST/gRPC/DB/Redis | `server_template_rendering.rs` | `test_template_content_server.py` |
...
| library | go/rust/ts/dart/csharp/swift | — | 新規追加 | `test_template_content_library.py` |
...
| devcontainer | go/rust/ts/dart/csharp | DB/Kafka/Redis | `devcontainer_template_rendering.rs` | `test_template_content_devcontainer.py` |
...
| `library_template_rendering.rs` | library (Go/Rust/TS/Dart/C#/Swift) | ~10 |
...
```
Test{Kind}{Framework}Templates.test_{feature}
```

例:
- `TestServerGoTemplates.test_main_go_exists` — Go サーバーテンプレートの main.go 存在確認
- `TestClientReactTemplates.test_package_json_exists` — React クライアントの package.json 存在確認
...
- [テンプレート仕様-React](テンプレート仕様-React.md) — React クライアントテンプレートの詳細仕様
- [テンプレート仕様-Flutter](テンプレート仕様-Flutter.md) — Flutter クライアントテンプレートの詳細仕様
