...
| oapi-codegen（REST/Go） | `oapi-codegen.yaml` | `CLI/crates/k1s0-cli/templates/server/go/oapi-codegen.yaml.tera` |
| gqlgen（GraphQL/Go） | `gqlgen.yml` | `CLI/crates/k1s0-cli/templates/server/go/gqlgen.yml.tera` |
