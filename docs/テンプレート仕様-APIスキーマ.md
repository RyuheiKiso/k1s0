...
API 設計の全体像は [API設計](API設計.md) を参照。
...
API スキーマテンプレートで使用する変数を以下に示す。変数の定義と導出ルールの詳細は [テンプレートエンジン仕様](テンプレートエンジン仕様.md) を参照。
...
- [テンプレート仕様-Kong](テンプレート仕様-Kong.md) -- Kong テンプレート仕様（API ルーティング連携）
- [テンプレート仕様-Keycloak](テンプレート仕様-Keycloak.md) -- Keycloak テンプレート仕様（認証連携）
