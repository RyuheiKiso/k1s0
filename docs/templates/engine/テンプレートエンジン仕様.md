...
| `module_path` | String | regions/ からの相対パス | `regions/service/order/server/rust` |
...
| `go_module` | String | Go モジュール名（Go 時） | `github.com/org/k1s0/regions/service/order/server/go` |
...
| `service` | — | `order` | `server` | `rust` | `regions/service/order/server/rust` |
...
| `business` | `accounting` | `ledger-api` | `server` | `rust` | `regions/business/accounting/server/rust/ledger-api` |
...
|---|---|
| `regions/service/order/server/go` | `github.com/org/k1s0/regions/service/order/server/go` |
| `regions/system/server/rust/auth` | `github.com/org/k1s0/regions/system/server/rust/auth` |
| `regions/business/accounting/server/go/ledger-api` | `github.com/org/k1s0/regions/business/accounting/server/go/ledger-api` |
...
1. テストコンテキスト（JSON）を作成する
    ...
    cat > test-context.json << 'EOF'
    {
      ...
      "tier": "service",
      "domain": "",
      "module_path": "regions/service/order-api/server/rust",
      "language": "rust",
      "kind": "server",
      "api_style": "rest",
      "api_styles": ["rest"],
