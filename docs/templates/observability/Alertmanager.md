...
可観測性設計の全体像は [可観測性設計](../../observability/overview/可観測性設計.md) の Alertmanager → Teams 通知設計を参照。
...
- [可観測性設計](../../observability/overview/可観測性設計.md) -- 可観測性の全体設計（Alertmanager → Teams 通知設計）
