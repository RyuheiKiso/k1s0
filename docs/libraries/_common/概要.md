...
| k1s0-app-updater | デスクトップアプリ自動更新（App Registry バージョンチェック・Presigned URL ダウンロード・SHA-256/Cosign 署名検証） | Flutter デスクトップクライアント | [アプリ配布基盤設計](../../infrastructure/distribution/アプリ配布基盤設計.md) |
