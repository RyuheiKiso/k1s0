...
元ドキュメント: [認証認可設計.md](../design/認証認可設計.md)
...
- [認証認可設計.md](../design/認証認可設計.md) -- 基本方針・技術スタック
- [認証設計.md](../design/認証設計.md) -- OAuth 2.0 / OIDC 実装
- [サービス間認証設計.md](../design/サービス間認証設計.md) -- mTLS 設計
