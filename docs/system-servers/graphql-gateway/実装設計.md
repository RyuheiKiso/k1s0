...
system-graphql-gateway の Rust 実装詳細を定義する。概要・API 定義・アーキテクチャは [system-graphql-gateway設計.md](server設計.md) を参照。
...
- [system-graphql-gateway-デプロイ設計.md](デプロイ設計.md) -- Dockerfile・Helm values・デプロイ設計
- [proto設計.md](../../api/protocols/proto設計.md) -- ConfigService / TenantService / FeatureFlagService proto 定義
