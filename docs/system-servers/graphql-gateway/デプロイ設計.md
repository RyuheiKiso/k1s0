...
system-graphql-gateway の Dockerfile・Helm values・環境変数・ヘルスチェック・リソース制限を定義する。概要・API 定義・アーキテクチャは [system-graphql-gateway設計.md](server設計.md) を参照。
...
[API設計.md](../../api/gateway/API設計.md) の Kong ルーティング設計に従い、graphql-gateway を Kong に登録する。
...
- [system-graphql-gateway設計.md](server設計.md) -- 概要・API 定義・アーキテクチャ
- [system-graphql-gateway-実装設計.md](実装設計.md) -- Rust 実装詳細
...
- [API設計.md](../../api/gateway/API設計.md) -- Kong ルーティング設計
