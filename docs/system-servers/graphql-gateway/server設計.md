...
[認証認可設計.md](../../auth/design/認証認可設計.md) および [GraphQL設計.md](../../api/protocols/GraphQL設計.md) に基づき、以下の方針で実装する。
...
- [system-graphql-gateway-実装設計.md](実装設計.md) -- 実装設計の詳細
- [system-graphql-gateway-デプロイ設計.md](デプロイ設計.md) -- デプロイ設計の詳細
...
- [GraphQL設計.md](../../api/protocols/GraphQL設計.md) -- GraphQL 設計ガイドライン
