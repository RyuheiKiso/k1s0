...
| 言語 | パス |
| --- | --- |
| Rust | `regions/system/server/rust/notification/` |
...
全エンドポイントは [API設計.md](../../api/gateway/API設計.md) D-007 の統一エラーレスポンスに従う。エラーコードのプレフィックスは `SYS_NOTIFY_` とする。
...
- [system-notification-server-実装設計.md](system-notification-server-実装設計.md) -- 実装設計の詳細
- [system-notification-server-デプロイ設計.md](system-notification-server-デプロイ設計.md) -- デプロイ設計の詳細
