...
- Tier 間のアクセス制御は [認証認可設計](認証認可設計.md) の定義に基づく
...
- [サービスメッシュ設計](サービスメッシュ設計.md) -- Istio 詳細設計・耐障害性設計
- [認証認可設計](認証認可設計.md) -- mTLS・AuthorizationPolicy の詳細定義
...
- [kubernetes設計](kubernetes設計.md) -- Namespace・NetworkPolicy 設計
