...
| Tier     | デフォルトパーティション数 | レプリケーションファクター |
| -------- | -------------------------- | -------------------------- |
| system   | 6                          | 3                          |
| business | 3                          | 3                          |
| service  | 3                          | 3                          |
...
| `notification-server.order-event` | notification   | 注文通知                 |
| `analytics-server.all-events`     | analytics      | 分析用イベント集約       |
