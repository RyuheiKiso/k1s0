...
Dev Container の全体設計は [devcontainer設計](devcontainer設計.md) を参照。
...
Dev Container テンプレートで使用する変数を以下に示す。変数の定義と導出ルールの詳細は [テンプレートエンジン仕様](テンプレートエンジン仕様.md) を参照。

| 変数名          | 型     | devcontainer.json | compose.extend | post-create.sh | 用途                                          |
| --------------- | ------ | ----------------- | -------------- | -------------- | --------------------------------------------- |
| `service_name`  | String | 用                | 用             | 用             | コンテナ名、ワークスペース識別                |
| `language`      | String | 用                | ---            | 用             | 言語別 features / extensions / ツールの選択   |
...
| 言語/ツール | バージョン | 同期先                                                                |
| ----------- | ---------- | --------------------------------------------------------------------- |
| Go          | 1.23       | [CI-CD設計](CI-CD設計.md), [devcontainer設計](devcontainer設計.md)    |
| Rust        | 1.82       | [Dockerイメージ戦略](Dockerイメージ戦略.md), [devcontainer設計](devcontainer設計.md) |
| Node.js     | 22         | [CI-CD設計](CI-CD設計.md), [devcontainer設計](devcontainer設計.md)    |
| Python      | 3.12       | [devcontainer設計](devcontainer設計.md)                               |
...
- [devcontainer設計](devcontainer設計.md) --- Dev Container の全体設計
...
- [docker-compose設計](docker-compose設計.md) --- Docker Compose 設計
