...
テンプレートエンジン（`TemplateEngine::render_to_dir()`）によるレンダリング結果を `cargo test` で検証する Rust 統合テストの仕様。
...
## Library Chart 連携テスト（Rust 統合テスト）

Helm テンプレートから生成されるマニフェストファイルが、k1s0-common Library Chart を正しく呼び出していることを検証する。

テスト配置: `CLI/tests/snapshot_tests.rs`（または `CLI/tests/helm_library_chart_tests.rs`）
...
- [テンプレート仕様-レンダリングテスト](テンプレート仕様-レンダリングテスト.md) — 概要・テスト対象マトリクス・CI統合
- [テンプレート仕様-E2Eテスト](テンプレート仕様-E2Eテスト.md) — E2E テスト仕様
- [テンプレートエンジン仕様](テンプレートエンジン仕様.md) — テンプレート変数・フィルタ・構文の定義
- [テンプレート仕様-サーバー](テンプレート仕様-サーバー.md) — サーバーテンプレートの詳細仕様
- [テンプレート仕様-BFF](テンプレート仕様-BFF.md) — BFF テンプレートの詳細仕様
- [テンプレート仕様-Helm](テンプレート仕様-Helm.md) — Helm テンプレートの詳細仕様
