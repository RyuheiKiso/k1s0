...
| event-monitor | 8095 | 50200 | イベント監視・KPI |
| event-store | 8096 | — | イベントストア（EventSourcing） |
| file | 8097 | — | ファイル管理 |
| master-maintenance | 8098 | 50201 | マスタメンテナンス |
| navigation | 8099 | 50202 | ナビゲーション（メニュー等） |
| notification | 8100 | — | 通知（Email/SMS/Push/Slack） |
| policy | 8101 | 50203 | ポリシー管理 |
| quota | 8102 | — | クォータ管理 |
| rule-engine | 8103 | 50204 | ルールエンジン |
...
| master-maintenance | rule-engine (50204) | ルール評価 |
