...
<img src="images/service-dependency-topology.svg" width="1400" />
...
| event-monitor | 8095 | 50400 | イベント監視・KPI |
| event-store | 8096 | — | イベントストア（EventSourcing） |
| file | 8097 | — | ファイル管理 |
| master-maintenance | 8098 | 50401 | マスタメンテナンス |
| navigation | 8099 | 50402 | ナビゲーション（メニュー等） |
| notification | 8100 | — | 通知（Email/SMS/Push/Slack） |
| policy | 8101 | 50403 | ポリシー管理 |
| quota | 8102 | — | クォータ管理 |
| rule-engine | 8103 | 50404 | ルールエンジン |
| scheduler | 8104 | — | スケジューラー |
| search | 8105 | — | 検索 |
| workflow | 8107 | — | ワークフロー |
| service-catalog | 8108 | — | サービスカタログ |
| ai-gateway | 8120 | 50206 | AI ゲートウェイ |
| ai-agent | 8121 | 50207 | AI エージェント |
...
| ai-agent | ai-gateway (50206) | AI モデル呼び出し |
| master-maintenance | rule-engine (50404) | ルール評価 |
...
<img src="images/service-failure-impact.svg" width="1400" />
