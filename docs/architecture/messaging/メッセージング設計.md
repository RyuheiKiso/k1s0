...
| トピック名                                              | 用途                         |
| ------------------------------------------------------- | ---------------------------- |
| `k1s0.service.task.created.v1`                          | タスク作成イベント           |
| `k1s0.service.task.updated.v1`                          | タスク更新イベント（旧 `task_status_changed_topic` から分割） |
| `k1s0.service.task.cancelled.v1`                        | タスクキャンセルイベント（旧 `task_status_changed_topic` から分割） |
| `k1s0.service.board.column_updated.v1`                  | ボードカラム更新イベント     |
| `k1s0.service.activity.created.v1`                      | アクティビティ記録イベント   |
| `k1s0.business.taskmanagement.projectmaster.project_type_changed.v1`   | プロジェクトタイプ変更イベント |
| `k1s0.business.taskmanagement.projectmaster.status_definition_changed.v1`     | ステータス定義変更イベント   |
