...
```
Phase 1 のみの中小企業シナリオ:
  投資:   2,000,000 円（1〜2 ヶ月の学習・導入期間）
  年間効果: 6,120,000 円（156+186+120+150 万円）
  回収期間: 2,000,000 ÷ 6,120,000 ≈ 約3.9ヶ月 ≈ 約3ヶ月
```
...
| **中小企業** | Phase 1（200 万円）のみで約 3 ヶ月で回収。K8s 不要で年間約 900 万円の効果 | 企業規模別分析（9.2） |
| **大手企業** | 年間約 7,200 万円の効果、8 ヶ月で回収、5 年累積 **3.1 億円のプラス** | 企業規模別分析（9.4） |
| **SIer** | 1 回の投資で 10 案件に展開、年間約 8,000 万円・5 ヶ月で回収 | 企業規模別分析（9.5） |
