...
- NFR-D-PLN-001 requires 20_機能要件/02_機能一覧.md の Phase 1b MUST 群
...
1. **tier1 公開 API 11 本稼働**: 20_機能要件/02_機能一覧.md の Phase 1b MUST 群
2. **NFR-B-PERF-001 達成**: Istio Ambient、リソース設計、キャッシュ、監視
3. **NFR-A-DR-001 / NFR-A-REC-002 達成**: RTO 4h、Runbook、オンコール、訓練、FMEA
4. **運用体制**: OR-INC-001〜007、OR-SUP-001〜006、OR-ENV-001〜006 の Phase 1b 項目
...
**NFR を外す判断時**: 例として NFR-B-PERF-001 を Phase 1a から外す提案があった場合、本索引から FR-T1-INVOKE-001 / FR-T1-STATE-001 の品質基準セクションを確認し、「500ms 未達でも tier2 業務継続が可能か」を Product Council で判断する。
