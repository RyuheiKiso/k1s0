...
- **M14: Phase 2 α リリース**— 全 11 API の α 公開、3 業務アプリが staging で稼働、ZEN Engine の本番採用判断完了と Temporal 運用 Runbook / Replay テスト整備完了を合格とする。未達は P-BIZ-003 の規模拡大判定（U-001）の延期に直結する
