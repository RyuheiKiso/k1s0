...
- [ADR-0001](../../../02_構想設計/adr/ADR-0001-architecture-basics.md)（アーキテクチャ基本）/ [ADR-0003](../../../02_構想設計/adr/ADR-0003-agpl-isolation-architecture.md)（AGPL 分離）/ ADR-POL-001（Kyverno 二分所有モデル、本章初版策定時に起票予定）
