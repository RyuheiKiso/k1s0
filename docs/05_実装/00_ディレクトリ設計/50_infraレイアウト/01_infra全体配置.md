...
| Phase | 対象 |
|---|---|
| Phase 0 | 構造のみ（ディレクトリと README） |
| Phase 1a | k8s/bootstrap + k8s/namespaces（最小 k3s 起動） |
| Phase 1b | mesh / dapr / observability の最小導入、data 層 1 Operator |
| Phase 1c | security 全層、data 層全 Operator、feature-management、scaling |
| Phase 2 | environments/ 全環境、DR / multi-region 対応 |
