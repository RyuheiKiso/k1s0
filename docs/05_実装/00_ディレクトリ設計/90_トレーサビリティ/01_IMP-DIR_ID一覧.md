...
| IMP-DIR-ROOT-013 〜 020 | Phase 1b 以降で採番 | 予約 |
...
| IMP-DIR-T1-027 〜 040 | Phase 1b 以降で採番 | 予約 |
...
| IMP-DIR-T2-047 〜 055 | Phase 1b 以降で採番 | 予約 |
...
| IMP-DIR-T3-061 〜 070 | Phase 1b 以降で採番 | 予約 |
...
| IMP-DIR-INFRA-079 〜 082 | Phase 1b 以降で採番 | 予約: feature-management / scaling / multi-region / backup-restore |
| IMP-DIR-INFRA-083 〜 086 | Phase 1c 以降で採番 | 予約: hardware-profile / cost-optimization / green-ops / air-gap |
| IMP-DIR-INFRA-087 〜 090 | Phase 2 以降で採番 | 予約: 将来のインフラ領域追加用（未割当バッファ） |
...
| IMP-DIR-OPS-098 〜 110 | Phase 1b 以降で採番 | 予約 |
...
| IMP-DIR-COMM-117 〜 125 | Phase 1b 以降で採番 | 予約 |
...
| IMP-DIR-SPARSE-133 〜 145 | Phase 1b 以降で採番 | 予約 |
