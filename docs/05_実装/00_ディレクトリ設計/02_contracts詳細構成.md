...
plugins:
  ...
  - remote: buf.build/grpc/go
    ...
    opt:
      - paths=source_relative
  # Rust 生成（Phase 1a は build.rs 方式も併用し、CI で drift 検出）
  - remote: buf.build/community/neoeinstein-prost
    out: ../rust/crates/proto-gen/src/generated
    opt:
      - no_include
...
```
src/tier1/rust/crates/proto-gen/
├── Cargo.toml
...
option go_package = "github.com/k1s0/k1s0/src/tier1/go/internal/proto/v1/state;statev1";
