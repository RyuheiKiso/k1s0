...
|---|---|
| [NFR-H-INT-001](../../../03_要件定義/30_非機能要件/E_セキュリティ.md)（署名付きアーティファクト） | BUF-014, OAS-025（生成物 commit と検証経路） |
...
| NFR-Q-PROD-002（CI 自動化） | POL-002, BUF-013〜014, OAS-024〜025, SCF-034〜035, GLD-042〜045 |
