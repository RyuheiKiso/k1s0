...
移行コスト試算は Phase 1a 後半の ADR-SUP-001 改訂レビューで確定する。Phase 0 は public 依存のまま運用する。
...
- IMP-SUP-COS-016: Phase 1b オンプレ Fulcio / Rekor 移行手順の予約
