...
実装段階は 13 章で構成する。世界トップ企業事例（Google / Meta / Microsoft / Uber / Netflix / Shopify 等）の調査と 4 エージェント多ラウンド議論（[docs/99_壁打ち/2026-04-23_05_実装フォルダ構成議論.md](../99_壁打ち/2026-04-23_05_実装フォルダ構成議論.md)）を経て、以下の構成に確定した。
