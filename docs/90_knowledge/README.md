# 90_archive — 過去構想スタック参考資料

> **NOTE: archive 済み** — 本ディレクトリは v1 採用 OSS stack と drift した過去構想の参考資料です。本流の OSS 選定は [02_要件定義/04_技術選定/01_OSS採用一覧.md](../02_要件定義/04_技術選定/01_OSS採用一覧.md) を参照してください。Dapr / Istio Ambient / k3s / Mender / EMQX / Grafana Tempo / Pyroscope 等は v1 では不採用です。
...
- [layered-architecture_basics.md](architecture/layered-architecture_basics.md)
...
- [kubernetes_pod.md](infra/kubernetes_pod.md)
- [kubernetes_namespace.md](infra/kubernetes_namespace.md)
...
- [proxy_basics.md](infra/proxy_basics.md)
