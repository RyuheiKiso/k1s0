...
- **Rust**: `rg --files -g 'Cargo.toml' regions CLI | sort` で探索し、ワークスペースルート (`CLI/Cargo.toml`, `regions/system/Cargo.toml`, `CLI/crates/k1s0-gui/Cargo.toml`) をスキップ
