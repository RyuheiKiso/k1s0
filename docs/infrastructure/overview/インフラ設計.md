...
![インフラ全体構成図](images/infra-overview.svg)
...
| オブジェクト     | Ceph RGW     | バックアップ・ログアーカイブ・アプリバイナリ配布 |
...
├── k1s0-system/       # system tier のイメージ
├── k1s0-business/     # business tier のイメージ
├── k1s0-service/      # service tier のイメージ
...
詳細は [terraform設計](../terraform/terraform設計.md) を参照。
...
- [アプリ配布基盤設計](../distribution/アプリ配布基盤設計.md)
