...
| `business` | domain-master-rust | business tier サーバー |
| `service` | order-rust, inventory-rust, payment-rust | service tier サーバー |
...
| 環境変数 | デフォルト | サービス | 説明 |
| --- | --- | --- | --- |
| `DOMAIN_MASTER_REST_HOST_PORT` | 8210 | domain-master-rust | Domain Master（REST） |
| `DOMAIN_MASTER_GRPC_HOST_PORT` | 9210 | domain-master-rust | Domain Master（gRPC） |

### Service サービス

| 環境変数 | デフォルト | サービス | 説明 |
| --- | --- | --- | --- |
| `ORDER_REST_HOST_PORT` | 8310 | order-rust | Order（REST） |
| `ORDER_GRPC_HOST_PORT` | 9310 | order-rust | Order（gRPC） |
| `INVENTORY_REST_HOST_PORT` | 8320 | inventory-rust | Inventory（REST） |
| `INVENTORY_GRPC_HOST_PORT` | 9320 | inventory-rust | Inventory（gRPC） |
| `PAYMENT_REST_HOST_PORT` | 8330 | payment-rust | Payment（REST） |
| `PAYMENT_GRPC_HOST_PORT` | 9330 | payment-rust | Payment（gRPC） |
...
| inventory-rust | postgres, kafka | 在庫管理 |
| payment-rust | postgres, kafka | 決済管理 |
