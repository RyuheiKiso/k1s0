...
ただし「2 エンジン併用」は運用工数の増加を招く。[../../01_企画/03_ロードマップと体制/03_運用工数試算.md](../../01_企画/03_ロードマップと体制/03_運用工数試算.md) で合意した年 0.5 人月の増分を本章の運用設計で吸収する。これを超える複雑化は本章の判定ロジックを簡素化することで対処する。
...
2 エンジン併用は運用工数を増加させる。企画書 [../../01_企画/03_ロードマップと体制/03_運用工数試算.md](../../01_企画/03_ロードマップと体制/03_運用工数試算.md) では以下の増分を計上している。
