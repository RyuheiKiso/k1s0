...
- `01_認証方式設計.md` — OIDC / mTLS / SPIFFE の採用方式、ID 発行者・検証者・フェデレーション方針を記述する。要件 ID `NFR-E-AUTH-*` と対応する。
...
- `09_Feature Management方式.md` — フラグ評価方式、ロールアウト戦略（カナリー / パーセンテージ / テナント指定）、フラグの廃止ライフサイクルを記述する。
