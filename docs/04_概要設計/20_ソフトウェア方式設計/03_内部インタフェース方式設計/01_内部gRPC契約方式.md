...
**確定フェーズ**: Phase 1a。**対応要件**: NFR-D-TRACE-\*、NFR-E-AUTH-\*、FR-T1-LOG-\*。
...
**確定フェーズ**: Phase 1a。**対応要件**: NFR-E-AUTH-\*、NFR-E-AUTHZ-\*。
...
**確定フェーズ**: Phase 1a。**対応要件**: NFR-D-MON-\*、NFR-D-TRACE-\*、NFR-E-AUTH-\*。
...
**確定フェーズ**: Phase 1a。**対応要件**: NFR-A-FT-001、NFR-E-CONN-\*。
...
- NFR-E-AUTH-\* / NFR-E-AUTHZ-\* / NFR-E-ERR-\* / NFR-E-CONN-\*（セキュリティ・通信）
