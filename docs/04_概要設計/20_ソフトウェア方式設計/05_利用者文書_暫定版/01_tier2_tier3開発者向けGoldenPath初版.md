...
- `DS-SW-DOC-002`（Backstage Template 生成物）: `DX-GP-004` / `DX-GP-005` / `FR-T1-SEC-003` / `FR-T1-AUD-002`
- `DS-SW-DOC-003`（SDK 1 行呼び出しサンプル）: `DX-GP-006` / `FR-T1-STATE-001` / `FR-T1-PUBSUB-001` / `FR-T1-DEC-001`
- `DS-SW-DOC-004`（落とし穴と対処）: `DX-GP-007` / `BR-PLATUSE-003` / `FR-T1-AUTH-004`
