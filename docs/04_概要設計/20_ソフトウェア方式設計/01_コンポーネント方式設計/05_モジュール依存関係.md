...
**確定フェーズ**: Phase 0。**対応要件**: NFR-A-CONT-003、NFR-E-AUTH-\*。
...
**確定フェーズ**: Phase 1a/1b/1c。**対応要件**: NFR-E-AUTH-\*、NFR-E-AUTHZ-\*、DX-GP-\*。
...
- NFR-D-MON-\*、NFR-D-TRACE-\*、NFR-E-AUTH-\*、NFR-E-AUTHZ-\*、NFR-E-ENC-001、NFR-F-ENV-\*、NFR-H-INT-001
