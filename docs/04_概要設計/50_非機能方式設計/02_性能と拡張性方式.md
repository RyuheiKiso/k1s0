...
11 API のうち特に厳しい目標を持つものは Decision（p99 1ms）、State Get（p99 10ms）、PubSub Publish（p99 50ms）、Workflow Start（p99 500ms）である。これらは要件定義 NFR-B-PERF-003〜005 および NFR-I-SLO-006 で確定しており、積算モデルのサブセットとして以下で方式化する。
