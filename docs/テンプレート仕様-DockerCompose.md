...
Docker Compose 設計の全体像は [docker-compose設計](docker-compose設計.md) を参照。
...
Docker Compose テンプレートで使用する変数を以下に示す。変数の定義と導出ルールの詳細は [テンプレートエンジン仕様](テンプレートエンジン仕様.md) を参照。
...
- [docker-compose設計](docker-compose設計.md) --- Docker Compose の全体設計・プロファイル・サービス定義
...
- [config設計](config設計.md) --- config.yaml / config.dev.yaml の設計
- [devcontainer設計](devcontainer設計.md) --- 開発コンテナの設定
- [可観測性設計](可観測性設計.md) --- Jaeger・Prometheus・Grafana・Loki の設計
- [メッセージング設計](メッセージング設計.md) --- Kafka の設計
