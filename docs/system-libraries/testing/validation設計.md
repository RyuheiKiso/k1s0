...
- [API設計](../../api/gateway/API設計.md) — API リクエスト検証での利用
- [system-library-idempotency設計](../resilience/idempotency設計.md) — リクエスト ID 検証での活用
- [proto設計](../../api/protocols/proto設計.md) — gRPC リクエスト構造体のバリデーション
