...
- [system-library-retry設計](retry設計.md) — k1s0-retry ライブラリ（内部依存）
- [system-library-circuit-breaker設計](circuit-breaker設計.md) — k1s0-circuit-breaker ライブラリ（内部依存）
- [可観測性設計](../../observability/overview/可観測性設計.md) — OpenTelemetry メトリクス設計
- [gRPC設計](../../api/protocols/gRPC設計.md) — サービス間呼び出し設計
