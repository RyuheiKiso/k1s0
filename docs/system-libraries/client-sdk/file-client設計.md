...
- [system-library-encryption設計](../auth-security/encryption設計.md) — ファイル暗号化との組み合わせ
- [system-library-quota-client設計](quota-client設計.md) — ストレージクォータ管理
- [system-library-audit-client設計](../observability/audit-client設計.md) — ファイル操作の監査ログ
