...
- [system-search-server設計](../../system-servers/search/server設計.md) — 検索サーバー設計
- [system-library-pagination設計](../data/pagination設計.md) — ページネーションライブラリ（SearchResult のページング）
- [system-library-eventstore設計](../data/eventstore設計.md) — イベント永続化（ドメインイベントから検索インデックス更新）
- [system-library-kafka設計](../messaging/kafka設計.md) — Kafka コンシューマー（インデックス更新イベント）
