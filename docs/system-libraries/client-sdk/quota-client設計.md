...
- [system-library-file-client設計](file-client設計.md) — ストレージクォータ管理の利用例
- [system-library-cache設計](../data/cache設計.md) — ポリシーキャッシュの実装参考
- [system-ratelimit-server設計](../../system-servers/ratelimit/server設計.md) — レートリミットとクォータの関係
