...
- [REST-API設計](../../api/protocols/REST-API設計.md) — D-007 統一レスポンス形式定義
- [API設計](../../api/gateway/API設計.md) — ページネーション方針（オフセット vs カーソル選択基準）
- [system-library-cache設計](cache設計.md) — ページネーション結果のキャッシュ
- [system-library-serviceauth設計](../auth-security/serviceauth設計.md) — ページネーション API への認証統合
