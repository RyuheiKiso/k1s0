...
- [system-library-messaging設計](../messaging/messaging設計.md) — Kafka イベント発行との連携
- [system-library-outbox設計](../messaging/outbox設計.md) — トランザクショナルアウトボックスパターン
- [system-saga-server設計](../../system-servers/saga/server設計.md) — Saga オーケストレーションとのイベント連携
- [メッセージング設計](../../architecture/messaging/メッセージング設計.md) — Kafka トピック設計
- [system-database設計](../../system-servers/common/database設計.md) — PostgreSQL スキーマ設計
