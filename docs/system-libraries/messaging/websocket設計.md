...
- [system-library-graphql-client設計](../client-sdk/graphql-client設計.md) — GraphQL クライアント（サブスクリプション接続管理の上位ラッパー）
- [system-library-notification-client設計](notification-client設計.md) — 通知クライアント（WebSocket 経由のリアルタイム通知受信）
- [system-notification-server設計](../../system-servers/notification/server設計.md) — 通知サーバー設計
