...
- スループット 10,000 メッセージ/秒を目標（Phase 2 で）
...
- MirrorMaker2 で DR 用クラスタへのレプリケーション（Phase 3）
...
- MirrorMaker2 による DR クラスタ構成が Phase 3 で選択可能
...
- DR レプリケーション（MirrorMaker2）構成を Phase 3 で POC
