...
- ADR-TEST-009（観測性 E2E 5 検証 owner only）— Loki / Tempo / Mimir / Grafana の機能継続検証を 5 検証（trace 貫通 / cardinality regression / log↔trace 結合 / SLO alert 発火 / dashboard goldenfile）として実装
