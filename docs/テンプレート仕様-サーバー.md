...
| ドキュメント | 内容 |
|---|---|
| [テンプレート仕様-サーバー-Rust](テンプレート仕様-サーバー-Rust.md) | Rust/axum+tokio テンプレート（main.rs・ドメイン・usecase・adapter・infra の詳細） |
| [テンプレート仕様-サーバー-C#](テンプレート仕様-サーバー-C#.md) | C#/ASP.NET Core テンプレート（Program.cs・DI設定・ミドルウェア・コントローラー・gRPC の詳細） |
| [テンプレート仕様-サーバー-可観測性](テンプレート仕様-サーバー-可観測性.md) | 可観測性テンプレート・OpenTelemetry設定 |
| [テンプレート仕様-サーバー-認証](テンプレート仕様-サーバー-認証.md) | 認証認可Middlewareテンプレート |
