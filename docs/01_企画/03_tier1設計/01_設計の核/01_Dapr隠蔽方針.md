...
この階層付けにより「infra 層への直接依存は tier1 のみ」という依存ルール ([`../../02_アーキテクチャ/01_基礎/02_依存ルールと通信経路.md`](../../02_アーキテクチャ/01_基礎/02_依存ルールと通信経路.md)) を維持できる。
...
- [`../../02_アーキテクチャ/01_基礎/02_依存ルールと通信経路.md`](../../02_アーキテクチャ/01_基礎/02_依存ルールと通信経路.md) — 依存ルールと通信
- [`../../04_技術選定/02_中核OSS/01_実行基盤中核OSS.md`](../../04_技術選定/02_中核OSS/01_実行基盤中核OSS.md) — Dapr の選定根拠
