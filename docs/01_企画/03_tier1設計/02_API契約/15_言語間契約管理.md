...
[Buf](https://buf.build/) は Protobuf スキーマの lint / 後方互換性検証の事実上の標準ツール ([`../../04_技術選定/03_周辺OSS/10_Protobufとロールアウト.md`](../../04_技術選定/03_周辺OSS/10_Protobufとロールアウト.md) で採用済み)。本資料では `buf breaking` を CI に組み込んで破壊的変更を機械的に検出する。
...
Testcontainers を用いて以下を実行する ([`../../04_技術選定/03_周辺OSS/07_ストレージと運用補助.md#P`](../../04_技術選定/03_周辺OSS/07_ストレージと運用補助.md))。
...
Phase 2 以降、Litmus ([`../../04_技術選定/03_周辺OSS/07_ストレージと運用補助.md`](../../04_技術選定/03_周辺OSS/07_ストレージと運用補助.md)) で以下を検証する。
...
- [`../../04_技術選定/03_周辺OSS/10_Protobufとロールアウト.md`](../../04_技術選定/03_周辺OSS/10_Protobufとロールアウト.md) — Buf の採用根拠
- [`../../04_技術選定/01_俯瞰/18_言語選定の定量分析.md`](../../04_技術選定/01_俯瞰/18_言語選定の定量分析.md) — Go / Rust 選定の定量根拠
