...
- [`../../../04_技術選定/02_中核OSS/01_実行基盤中核OSS.md`](../../../04_技術選定/02_中核OSS/01_実行基盤中核OSS.md) — Istio / Envoy Gateway 採用根拠
- [`../../../04_技術選定/03_周辺OSS/02_周辺OSS.md`](../../../04_技術選定/03_周辺OSS/02_周辺OSS.md) — cert-manager / Litmus
- [`../../../04_技術選定/03_周辺OSS/08_シークレット管理.md`](../../../04_技術選定/03_周辺OSS/08_シークレット管理.md) — OpenBao によるルート CA 管理
