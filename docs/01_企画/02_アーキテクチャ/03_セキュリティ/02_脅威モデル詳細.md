...
- **ライセンス改変の追跡**: AGPL 条項が将来変更された場合（BSL 化など）、差し替え先の事前評価を [`../../04_技術選定/01_俯瞰/17_OSS長期戦略.md`](../../04_技術選定/01_俯瞰/17_OSS長期戦略.md) と連動して維持する。
...
- [`../../04_技術選定/01_俯瞰/17_OSS長期戦略.md`](../../04_技術選定/01_俯瞰/17_OSS長期戦略.md) — AGPL リスクと差し替えシナリオ
