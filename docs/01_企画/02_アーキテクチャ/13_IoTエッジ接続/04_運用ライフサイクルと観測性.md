...
エッジから tier1 への観測データは、以下 3 系統を整備する。これは k1s0 本体の観測性設計 ([`../06_プラットフォーム自己監視.md`](../06_プラットフォーム自己監視.md)) と整合する。
...
| publish 成功率 | `success / total publish attempts` | 99.9 % / 日 | `edge_publish_total` |
