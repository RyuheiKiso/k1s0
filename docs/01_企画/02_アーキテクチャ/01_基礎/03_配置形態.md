...
- [`../../04_技術選定/02_中核OSS/01_実行基盤中核OSS.md`](../../04_技術選定/02_中核OSS/01_実行基盤中核OSS.md) — 採用 OSS の選定根拠
- [`../../04_技術選定/03_周辺OSS/09_ネットワークとテレメトリ基盤.md`](../../04_技術選定/03_周辺OSS/09_ネットワークとテレメトリ基盤.md) — MetalLB / kube-vip / OTel Collector の選定根拠
