...
| namespace | 配置するもの |
|---|---|
| `infra` | Envoy Gateway / Istio Control Plane / Prometheus / Loki / Jaeger / Grafana / Kafka (Strimzi) / Harbor / Valkey / CloudNativePG + PostgreSQL / PgBouncer (CloudNativePG Pooler) / Kyverno / cert-manager / MinIO / Longhorn |
...
| ストレージ | Longhorn (CNCF Incubating)。3 ノードレプリケーションでデータ保護。CloudNativePG / MinIO の PV を管理 |
