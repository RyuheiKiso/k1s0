...
## 6. OSS 公開時の職務著作・知財帰属（著作権法 §15）

k1s0 を将来的に OSS 公開する際、社内発コードの著作権帰属と公開手続きを整備する必要がある。日本著作権法 §15 ①（一般著作物）は（i）法人等の発意、（ii）業務従事者が職務上作成、（iii）法人等名義で公表、（iv）契約・就業規則に別段の定めなし、の 4 要件で著作権が法人に帰属する。§15 ②はプログラム著作物の特例で「公表名義要件」を不要とする。つまり就業規則に「職務上作成する著作物の著作者は法人」と明記されていれば、社内レビュー経由の OSS 公開（= 社の著作物の二次ライセンス付与）として処理できる。
...
- **社内 fork を OSS 公開する際の職務著作規程整備**: §15 ②ベースの社内規程と OSPO 相当の統括窓口。
