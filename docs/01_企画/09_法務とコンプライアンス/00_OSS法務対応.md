...
これらの選定根拠は [`../04_技術選定/15_サプライチェーンセキュリティ.md`](../04_技術選定/15_サプライチェーンセキュリティ.md) を参照。
...
- [`../04_技術選定/15_サプライチェーンセキュリティ.md`](../04_技術選定/15_サプライチェーンセキュリティ.md) — Syft / Grype / Cosign の採用根拠
