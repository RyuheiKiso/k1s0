...
追加採用 OSS (ストレージ / 接続プーリング / 依存管理 / イベント自動化) は [`07_追加採用OSS.md`](./07_追加採用OSS.md) で別扱いとする。
...
グレースフルデグラデーション設計 ([`../02_アーキテクチャ/08_グレースフルデグラデーション.md`](../02_アーキテクチャ/08_グレースフルデグラデーション.md)) で定義した縮退動作が実装と一致することを自動検証する。
...
- [`../02_アーキテクチャ/08_グレースフルデグラデーション.md`](../02_アーキテクチャ/08_グレースフルデグラデーション.md) — Litmus で検証する縮退動作の定義
- [`../02_アーキテクチャ/05_障害復旧とバックアップ.md`](../02_アーキテクチャ/05_障害復旧とバックアップ.md) — MinIO をバックアップ先として利用
