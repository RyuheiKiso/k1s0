...
詳細は [`../../03_tier1設計/01_設計の核/01_Dapr隠蔽方針.md`](../../03_tier1設計/01_設計の核/01_Dapr隠蔽方針.md) を参照。
...
**採用方針**: tier1 内部は Daprファサード = Go、自作領域 = Rust のハイブリッド構成。詳細は [`../../03_tier1設計/01_設計の核/02_内部言語ハイブリッド.md`](../../03_tier1設計/01_設計の核/02_内部言語ハイブリッド.md) を参照。
...
- [`../../03_tier1設計/01_設計の核/01_Dapr隠蔽方針.md`](../../03_tier1設計/01_設計の核/01_Dapr隠蔽方針.md) — Dapr を採用したうえで tier1 が何を隠蔽するか（本資料の選定を受けた設計判断）
- [`../../03_tier1設計/01_設計の核/02_内部言語ハイブリッド.md`](../../03_tier1設計/01_設計の核/02_内部言語ハイブリッド.md) — Go + Rust の設計意図（本資料の言語選定を受けた設計判断）
