...
[`04_APIバージョニング戦略.md`](../../03_tier1設計/02_API契約/04_APIバージョニング戦略.md) および [`03_API設計原則.md`](../../03_tier1設計/02_API契約/03_API設計原則.md) で Buf の利用は既に前提とされている。本ドキュメントは正式な選定根拠の記録である。
...
- [`../../03_tier1設計/02_API契約/04_APIバージョニング戦略.md`](../../03_tier1設計/02_API契約/04_APIバージョニング戦略.md) — Buf の利用を前提とした Protobuf 契約管理
- [`../../03_tier1設計/02_API契約/03_API設計原則.md`](../../03_tier1設計/02_API契約/03_API設計原則.md) — CI ガードの一部として Buf を利用
