...
- [`../../02_アーキテクチャ/04_非機能とデータ/03_レート制限.md`](../../02_アーキテクチャ/04_非機能とデータ/03_レート制限.md) — Rate Limiting
- [`../../02_アーキテクチャ/02_可用性と信頼性/01_障害復旧とバックアップ.md`](../../02_アーキテクチャ/02_可用性と信頼性/01_障害復旧とバックアップ.md) — Longhorn によるデータ保護
- [`../../02_アーキテクチャ/04_非機能とデータ/02_データアーキテクチャ.md`](../../02_アーキテクチャ/04_非機能とデータ/02_データアーキテクチャ.md) — PgBouncer による接続管理 / スキーマ進化戦略
