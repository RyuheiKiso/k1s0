...
| **Phase 2** | 基盤拡張、2〜3 名体制 | Istio + Kafka + Apicurio Registry + Grafana Tempo / OTel Gateway + Backstage + tier1 Rust / ZEN Engine + OpenFeature / flagd (Feature Flag) + Litmus (Chaos Engineering) + tier2 サンプル |
