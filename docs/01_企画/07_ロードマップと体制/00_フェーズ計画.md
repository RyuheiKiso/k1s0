...
OSS の導入時期は [`../04_技術選定/01_俯瞰/19_フェーズ別採用タイムライン.md`](../04_技術選定/01_俯瞰/19_フェーズ別採用タイムライン.md)、体制の詳細は [`02_体制と役割.md`](./02_体制と役割.md) を参照。本章では「いつ何をするか」の時系列、「04 章」では「どの OSS が Intro/Prod になるか」、「02 章」では「誰が何を担当するか」を扱う。
...
- [`../04_技術選定/03_周辺OSS/06_イベントスキーマレジストリ.md`](../04_技術選定/03_周辺OSS/06_イベントスキーマレジストリ.md) — Apicurio Registry の段階導入
...
- [`../04_技術選定/02_中核OSS/03_ルールエンジン.md`](../04_技術選定/02_中核OSS/03_ルールエンジン.md) — ZEN Engine の段階導入
- [`../04_技術選定/03_周辺OSS/12_マニフェストとワークフロー.md`](../04_技術選定/03_周辺OSS/12_マニフェストとワークフロー.md) — Kustomize + Helm / Temporal の段階導入
- [`../04_技術選定/03_周辺OSS/14_オートスケーラー.md`](../04_技術選定/03_周辺OSS/14_オートスケーラー.md) — KEDA の段階導入
- [`../04_技術選定/03_周辺OSS/16_プロファイリング.md`](../04_技術選定/03_周辺OSS/16_プロファイリング.md) — Grafana Pyroscope の段階導入
