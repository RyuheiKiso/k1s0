...
| **Phase 2** | 基盤拡張、2〜3 名体制 | Istio + Kafka + Apicurio Registry + Grafana Tempo / OTel Gateway + Backstage + tier1 Rust / ZEN Engine + OpenFeature / flagd (Feature Flag) + Litmus (Chaos Engineering) + **Temporal** (ワークフローエンジン) + tier2 サンプル |
...
- [`../04_技術選定/12_追加採用OSS_4.md`](../04_技術選定/12_追���採用OSS_4.md) — Kustomize + Helm / Temporal の段階導入
