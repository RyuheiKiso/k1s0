...
| Jaeger | 分散トレーシングはサービス間呼び出しが増えてから。OTel Collector は MVP-1a で先行導入済み | Phase 2 |
...
| ノード数 | 3 |
| vCPU / ノード | 4 |
| メモリ / ノード | 16 GB (合計 48 GB、余裕 約 29.5 GB) |
| ディスク / ノード | 200 GB SSD |
| ネットワーク | 1 Gbps |
...
ハードウェアは MVP-1a と同一 (3 ノード x 16 GB = 48 GB)。余裕 約 22.5 GB。
