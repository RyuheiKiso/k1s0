...
pub mod tenant_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub async fn watch_tenant(
            &mut self,
            request: impl tonic::IntoRequest<super::WatchTenantRequest>,
        ) -> std::result::Result<
            tonic::Response<tonic::codec::Streaming<super::WatchTenantResponse>>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("k1s0.system.tenant.v1.TenantService", "WatchTenant"),
                );
