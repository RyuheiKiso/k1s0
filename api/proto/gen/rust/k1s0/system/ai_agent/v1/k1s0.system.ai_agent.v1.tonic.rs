        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/k1s0.system.ai_agent.v1.AiAgentService/Execute",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("k1s0.system.ai_agent.v1.AiAgentService", "Execute"),
                );
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/k1s0.system.ai_agent.v1.AiAgentService/ExecuteStream",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/k1s0.system.ai_agent.v1.AiAgentService/CancelExecution",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        pub async fn review_step(
            &mut self,
            request: impl tonic::IntoRequest<super::ReviewStepRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ReviewStepResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/k1s0.system.ai_agent.v1.AiAgentService/ReviewStep",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub mod ai_agent_service_server {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with AiAgentServiceServer.
    #[async_trait]
    pub trait AiAgentService: std::marker::Send + std::marker::Sync + 'static {
        async fn execute(
            &self,
        ...
        async fn review_step(
            &self,
            request: tonic::Request<super::ReviewStepRequest>,
        ) -> std::result::Result<
            tonic::Response<super::ReviewStepResponse>,
            tonic::Status,
        >;
    ...
    #[derive(Debug)]
    pub struct AiAgentServiceServer<T> {
        inner: Arc<T>,
    ...
    impl<T, B> tonic::codegen::Service<http::Request<B>> for AiAgentServiceServer<T>
    where
        T: AiAgentService,
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/k1s0.system.ai_agent.v1.AiAgentService/Execute" => {
                    ...
                    struct ExecuteSvc<T: AiAgentService>(pub Arc<T>);
                    impl<
                        T: AiAgentService,
                    ...
                    for ExecuteSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as AiAgentService>::execute(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/k1s0.system.ai_agent.v1.AiAgentService/ExecuteStream" => {
                    ...
                    for ExecuteStreamSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AiAgentService>::execute_stream(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/k1s0.system.ai_agent.v1.AiAgentService/CancelExecution" => {
                    #[allow(non_camel_case_types)]
                    struct CancelExecutionSvc<T: AiAgentService>(pub Arc<T>);
                    impl<
                        T: AiAgentService,
                    ...
                    for CancelExecutionSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AiAgentService>::cancel_execution(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/k1s0.system.ai_agent.v1.AiAgentService/ReviewStep" => {
                    #[allow(non_camel_case_types)]
                    struct ReviewStepSvc<T: AiAgentService>(pub Arc<T>);
                    impl<
                        T: AiAgentService,
                    > tonic::server::UnaryService<super::ReviewStepRequest>
                    for ReviewStepSvc<T> {
                        type Response = super::ReviewStepResponse;
                        type Future = BoxFuture<
                            tonic::Response<Self::Response>,
                            tonic::Status,
                        >;
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AiAgentService>::review_step(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                    ...
                    let inner = self.inner.clone();
                    let fut = async move {
                        let method = ReviewStepSvc(inner);
                        let codec = tonic_prost::ProstCodec::default();
                        let mut grpc = tonic::server::Grpc::new(codec)
                            .apply_compression_config(
                                accept_compression_encodings,
    ...
    impl<T> Clone for AiAgentServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "k1s0.system.ai_agent.v1.AiAgentService";
    impl<T> tonic::server::NamedService for AiAgentServiceServer<T> {
