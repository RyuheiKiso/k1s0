...
pub mod ai_agent_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("k1s0.system.aiagent.v1.AiAgentService", "Execute"),
                );
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "k1s0.system.aiagent.v1.AiAgentService",
                        "ExecuteStream",
                    ),
                );
...
pub mod ai_agent_service_server {
    ...
    pub const SERVICE_NAME: &str = "k1s0.system.aiagent.v1.AiAgentService";
