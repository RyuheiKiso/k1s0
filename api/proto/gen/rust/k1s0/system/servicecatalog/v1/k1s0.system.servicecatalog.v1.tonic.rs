...
pub mod service_catalog_service_client {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    #[derive(Debug, Clone)]
    pub struct ServiceCatalogServiceClient<T> {
        inner: tonic::client::Grpc<T>,
    }
    impl ServiceCatalogServiceClient<tonic::transport::Channel> {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        pub fn with_interceptor<F>(
            inner: T,
            interceptor: F,
        ) -> ServiceCatalogServiceClient<InterceptedService<T, F>>
        where
        ...
        pub async fn register_service(
            ...
            tonic::Response<super::RegisterServiceResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
        ...
        pub async fn get_service(
            ...
            tonic::Response<super::GetServiceResponse>,
            tonic::Status,
        > {
            self.inner
                .ready()
...
pub mod service_catalog_service_server {
    #![allow(
        unused_variables,
        dead_code,
        missing_docs,
    ...
    use tonic::codegen::*;
    /// Generated trait containing gRPC methods that should be implemented for use with ServiceCatalogServiceServer.
    #[async_trait]
    pub trait ServiceCatalogService: std::marker::Send + std::marker::Sync + 'static {
    ...
    #[derive(Debug)]
    pub struct ServiceCatalogServiceServer<T> {
        inner: Arc<T>,
    ...
    impl<T> ServiceCatalogServiceServer<T> {
        pub fn new(inner: T) -> Self {
    ...
    for ServiceCatalogServiceServer<T>
    where
        T: ServiceCatalogService,
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/k1s0.system.servicecatalog.v1.ServiceCatalogService/RegisterService" => {
                    ...
                    struct RegisterServiceSvc<T: ServiceCatalogService>(pub Arc<T>);
                    impl<
                        T: ServiceCatalogService,
                    ...
                    for RegisterServiceSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as ServiceCatalogService>::register_service(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/k1s0.system.servicecatalog.v1.ServiceCatalogService/GetService" => {
                    #[allow(non_camel_case_types)]
                    struct GetServiceSvc<T: ServiceCatalogService>(pub Arc<T>);
                    impl<
                        T: ServiceCatalogService,
                    ...
                    for GetServiceSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ServiceCatalogService>::get_service(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/k1s0.system.servicecatalog.v1.ServiceCatalogService/ListServices" => {
                    #[allow(non_camel_case_types)]
                    struct ListServicesSvc<T: ServiceCatalogService>(pub Arc<T>);
                    impl<
                        T: ServiceCatalogService,
                    ...
                    for ListServicesSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ServiceCatalogService>::list_services(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/k1s0.system.servicecatalog.v1.ServiceCatalogService/UpdateService" => {
                    #[allow(non_camel_case_types)]
                    struct UpdateServiceSvc<T: ServiceCatalogService>(pub Arc<T>);
                    impl<
                        T: ServiceCatalogService,
                    ...
                    for UpdateServiceSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ServiceCatalogService>::update_service(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/k1s0.system.servicecatalog.v1.ServiceCatalogService/DeleteService" => {
                    #[allow(non_camel_case_types)]
                    struct DeleteServiceSvc<T: ServiceCatalogService>(pub Arc<T>);
                    impl<
                        T: ServiceCatalogService,
                    ...
                    for DeleteServiceSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ServiceCatalogService>::delete_service(
                                        &inner,
                                        request,
                                    )
                                    .await
                ...
                "/k1s0.system.servicecatalog.v1.ServiceCatalogService/HealthCheck" => {
                    #[allow(non_camel_case_types)]
                    struct HealthCheckSvc<T: ServiceCatalogService>(pub Arc<T>);
                    impl<
                        T: ServiceCatalogService,
                    ...
                    for HealthCheckSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as ServiceCatalogService>::health_check(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
    ...
    impl<T> Clone for ServiceCatalogServiceServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "k1s0.system.servicecatalog.v1.ServiceCatalogService";
    impl<T> tonic::server::NamedService for ServiceCatalogServiceServer<T> {
