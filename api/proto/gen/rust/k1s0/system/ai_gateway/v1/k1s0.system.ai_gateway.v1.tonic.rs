        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/k1s0.system.ai_gateway.v1.AiGatewayService/Complete",
            );
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/k1s0.system.ai_gateway.v1.AiGatewayService/CompleteStream",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        pub async fn embed(
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/k1s0.system.ai_gateway.v1.AiGatewayService/Embed",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/k1s0.system.ai_gateway.v1.AiGatewayService/ListModels",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/k1s0.system.ai_gateway.v1.AiGatewayService/GetUsage",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
...
pub mod ai_gateway_service_server {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/k1s0.system.ai_gateway.v1.AiGatewayService/Complete" => {
                    ...
                    struct CompleteSvc<T: AiGatewayService>(pub Arc<T>);
                    impl<
                        T: AiGatewayService,
                    ...
                    for CompleteSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as AiGatewayService>::complete(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/k1s0.system.ai_gateway.v1.AiGatewayService/CompleteStream" => {
                    ...
                    for CompleteStreamSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AiGatewayService>::complete_stream(&inner, request)
                                    .await
                            };
                            Box::pin(fut)
                        }
                ...
                "/k1s0.system.ai_gateway.v1.AiGatewayService/Embed" => {
                    #[allow(non_camel_case_types)]
                    struct EmbedSvc<T: AiGatewayService>(pub Arc<T>);
                    impl<
                        T: AiGatewayService,
                    > tonic::server::UnaryService<super::EmbedRequest> for EmbedSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AiGatewayService>::embed(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/k1s0.system.ai_gateway.v1.AiGatewayService/ListModels" => {
                    #[allow(non_camel_case_types)]
                    struct ListModelsSvc<T: AiGatewayService>(pub Arc<T>);
                    impl<
                        T: AiGatewayService,
                    ...
                    for ListModelsSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AiGatewayService>::list_models(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/k1s0.system.ai_gateway.v1.AiGatewayService/GetUsage" => {
                    #[allow(non_camel_case_types)]
                    struct GetUsageSvc<T: AiGatewayService>(pub Arc<T>);
                    impl<
                        T: AiGatewayService,
                    ...
                    for GetUsageSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as AiGatewayService>::get_usage(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
    ...
    pub const SERVICE_NAME: &str = "k1s0.system.ai_gateway.v1.AiGatewayService";
