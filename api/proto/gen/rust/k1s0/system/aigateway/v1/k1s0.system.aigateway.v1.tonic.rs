        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "k1s0.system.aigateway.v1.AiGatewayService",
                        "Complete",
                    ),
                );
        ...
        pub async fn embed(
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("k1s0.system.aigateway.v1.AiGatewayService", "Embed"),
                );
            self.inner.unary(req, path, codec).await
        }
...
pub mod ai_gateway_service_server {
    ...
    pub const SERVICE_NAME: &str = "k1s0.system.aigateway.v1.AiGatewayService";
