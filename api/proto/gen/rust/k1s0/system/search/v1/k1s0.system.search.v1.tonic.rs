...
pub mod search_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("k1s0.system.search.v1.SearchService", "CreateIndex"),
                );
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("k1s0.system.search.v1.SearchService", "ListIndices"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        pub async fn search(
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("k1s0.system.search.v1.SearchService", "Search"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                "/k1s0.system.search.v1.SearchService/CreateIndex" => {
                    ...
                    struct CreateIndexSvc<T: SearchService>(pub Arc<T>);
                    impl<
                        T: SearchService,
                    ...
                    for CreateIndexSvc<T> {
                        ...
                        fn call(
                            ...
                            let fut = async move {
                                <T as SearchService>::create_index(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
                ...
                "/k1s0.system.search.v1.SearchService/ListIndices" => {
                    #[allow(non_camel_case_types)]
                    struct ListIndicesSvc<T: SearchService>(pub Arc<T>);
                    impl<
                        T: SearchService,
                    ...
                    for ListIndicesSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as SearchService>::list_indices(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
