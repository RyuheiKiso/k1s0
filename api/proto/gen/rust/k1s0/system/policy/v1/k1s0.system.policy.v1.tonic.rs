...
pub mod policy_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("k1s0.system.policy.v1.PolicyService", "GetPolicy"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("k1s0.system.policy.v1.PolicyService", "ListBundles"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("k1s0.system.policy.v1.PolicyService", "GetBundle"),
                );
            self.inner.unary(req, path, codec).await
        }
    }
        ...
        B::Error: Into<StdError> + std::marker::Send + 'static,
    {
        ...
        fn call(&mut self, req: http::Request<B>) -> Self::Future {
            match req.uri().path() {
                ...
                "/k1s0.system.policy.v1.PolicyService/GetBundle" => {
                    #[allow(non_camel_case_types)]
                    struct GetBundleSvc<T: PolicyService>(pub Arc<T>);
                    impl<
                        T: PolicyService,
                    ...
                    for GetBundleSvc<T> {
                        ...
                        fn call(
                            ...
                            let inner = Arc::clone(&self.0);
                            let fut = async move {
                                <T as PolicyService>::get_bundle(&inner, request).await
                            };
                            Box::pin(fut)
                        }
                    }
