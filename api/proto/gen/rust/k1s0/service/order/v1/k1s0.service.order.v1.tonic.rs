...
pub mod order_service_client {
        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("k1s0.service.order.v1.OrderService", "CreateOrder"),
                );
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("k1s0.service.order.v1.OrderService", "GetOrder"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("k1s0.service.order.v1.OrderService", "ListOrders"),
                );
            self.inner.unary(req, path, codec).await
        }
...
pub mod order_service_server {
    ...
    pub const SERVICE_NAME: &str = "k1s0.service.order.v1.OrderService";
