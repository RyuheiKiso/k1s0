        ...
        <T::ResponseBody as Body>::Error: Into<StdError> + std::marker::Send,
    {
        ...
        > {
            ...
            let path = http::uri::PathAndQuery::from_static(
                "/k1s0.service.task.v1.TaskService/CreateTask",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("k1s0.service.task.v1.TaskService", "CreateTask"),
                );
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/k1s0.service.task.v1.TaskService/GetTask",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(GrpcMethod::new("k1s0.service.task.v1.TaskService", "GetTask"));
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/k1s0.service.task.v1.TaskService/ListTasks",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new("k1s0.service.task.v1.TaskService", "ListTasks"),
                );
            self.inner.unary(req, path, codec).await
        }
        ...
        > {
            ...
            let codec = tonic_prost::ProstCodec::default();
            let path = http::uri::PathAndQuery::from_static(
                "/k1s0.service.task.v1.TaskService/UpdateTaskStatus",
            );
            let mut req = request.into_request();
            req.extensions_mut()
                .insert(
                    GrpcMethod::new(
                        "k1s0.service.task.v1.TaskService",
                        "UpdateTaskStatus",
                    ),
                );
            self.inner.unary(req, path, codec).await
...
pub mod task_service_server {
    ...
    pub const SERVICE_NAME: &str = "k1s0.service.task.v1.TaskService";
