 ...
 *
 * @generated from protobuf message k1s0.system.ai_agent.v1.ExecuteRequest
 */
 ...
 *
 * @generated from protobuf message k1s0.system.ai_agent.v1.ExecuteResponse
 */
export interface ExecuteResponse {
     ...
     * 実行されたステップのリスト
     *
     * @generated from protobuf field: repeated k1s0.system.ai_agent.v1.ExecutionStep steps = 4
     */
    steps: ExecutionStep[];
}
/**
 ...
 *
 * @generated from protobuf message k1s0.system.ai_agent.v1.ExecutionStep
 */
 ...
 *
 * @generated from protobuf message k1s0.system.ai_agent.v1.CancelExecutionRequest
 */
 ...
 *
 * @generated from protobuf message k1s0.system.ai_agent.v1.CancelExecutionResponse
 */
 ...
 *
 * @generated from protobuf message k1s0.system.ai_agent.v1.ReviewStepRequest
 */
 ...
 *
 * @generated from protobuf message k1s0.system.ai_agent.v1.ReviewStepResponse
 */
...
class ExecuteRequest$Type extends MessageType<ExecuteRequest> {
    constructor() {
        super("k1s0.system.ai_agent.v1.ExecuteRequest", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case 2:
                    val = reader.string();
                    break;
                default: throw new globalThis.Error("unknown map entry field for k1s0.system.ai_agent.v1.ExecuteRequest.context");
            }
        }
        map[key ?? ""] = val ?? "";
    }
...
/**
 * @generated MessageType for protobuf message k1s0.system.ai_agent.v1.ExecuteRequest
 */
export const ExecuteRequest = new ExecuteRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ExecuteResponse$Type extends MessageType<ExecuteResponse> {
    constructor() {
        super("k1s0.system.ai_agent.v1.ExecuteResponse", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* string output */ 3:
                    ...
                    break;
                case /* repeated k1s0.system.ai_agent.v1.ExecutionStep steps */ 4:
    ...
    internalBinaryWrite(message: ExecuteResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* repeated k1s0.system.ai_agent.v1.ExecutionStep steps = 4; */
...
/**
 * @generated MessageType for protobuf message k1s0.system.ai_agent.v1.ExecuteResponse
 */
...
class ExecutionStep$Type extends MessageType<ExecutionStep> {
    constructor() {
        super("k1s0.system.ai_agent.v1.ExecutionStep", [
...
/**
 * @generated MessageType for protobuf message k1s0.system.ai_agent.v1.ExecutionStep
 */
...
class CancelExecutionRequest$Type extends MessageType<CancelExecutionRequest> {
    constructor() {
        super("k1s0.system.ai_agent.v1.CancelExecutionRequest", [
            { no: 1, name: "execution_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message k1s0.system.ai_agent.v1.CancelExecutionRequest
 */
...
class CancelExecutionResponse$Type extends MessageType<CancelExecutionResponse> {
    constructor() {
        super("k1s0.system.ai_agent.v1.CancelExecutionResponse", [
...
/**
 * @generated MessageType for protobuf message k1s0.system.ai_agent.v1.CancelExecutionResponse
 */
...
class ReviewStepRequest$Type extends MessageType<ReviewStepRequest> {
    constructor() {
        super("k1s0.system.ai_agent.v1.ReviewStepRequest", [
            { no: 1, name: "execution_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
/**
 * @generated MessageType for protobuf message k1s0.system.ai_agent.v1.ReviewStepRequest
 */
...
class ReviewStepResponse$Type extends MessageType<ReviewStepResponse> {
    constructor() {
        super("k1s0.system.ai_agent.v1.ReviewStepResponse", [
            { no: 1, name: "execution_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
/**
 * @generated MessageType for protobuf message k1s0.system.ai_agent.v1.ReviewStepResponse
 */
export const ReviewStepResponse = new ReviewStepResponse$Type();
/**
 * @generated ServiceType for protobuf service k1s0.system.ai_agent.v1.AiAgentService
 */
