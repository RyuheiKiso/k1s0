...
// @generated from protobuf file "k1s0/system/ai_gateway/v1/ai_gateway.proto" (package "k1s0.system.aigateway.v1", syntax proto3)
// tslint:disable
 ...
 *
 * @generated from protobuf message k1s0.system.aigateway.v1.CompleteRequest
 */
export interface CompleteRequest {
     ...
     * 補完に使用するメッセージ履歴
     *
     * @generated from protobuf field: repeated k1s0.system.aigateway.v1.Message messages = 2
     */
    messages: Message[];
    /**
     * 生成する最大トークン数
 ...
 *
 * @generated from protobuf message k1s0.system.aigateway.v1.Message
 */
 ...
 *
 * @generated from protobuf message k1s0.system.aigateway.v1.CompleteResponse
 */
 ...
 *
 * @generated from protobuf message k1s0.system.aigateway.v1.CompleteStreamRequest
 */
 ...
 *
 * @generated from protobuf message k1s0.system.aigateway.v1.CompleteStreamResponse
 */
 ...
 *
 * @generated from protobuf message k1s0.system.aigateway.v1.EmbedRequest
 */
 ...
 *
 * @generated from protobuf message k1s0.system.aigateway.v1.EmbedResponse
 */
export interface EmbedResponse {
     ...
     * 生成された埋め込みベクトルのリスト
     *
     * @generated from protobuf field: repeated k1s0.system.aigateway.v1.Embedding embeddings = 2
     */
 ...
 * 埋め込み: 単一入力に対するベクトル表現
 *
 * @generated from protobuf message k1s0.system.aigateway.v1.Embedding
 */
 ...
 *
 * @generated from protobuf message k1s0.system.aigateway.v1.AiModel
 */
 ...
 *
 * @generated from protobuf message k1s0.system.aigateway.v1.ListModelsRequest
 */
 ...
 *
 * @generated from protobuf message k1s0.system.aigateway.v1.ListModelsResponse
 */
export interface ListModelsResponse {
    /**
     * AI モデルのリスト
     *
     * @generated from protobuf field: repeated k1s0.system.aigateway.v1.AiModel models = 1
     */
    models: AiModel[];
}
/**
 ...
 *
 * @generated from protobuf message k1s0.system.aigateway.v1.GetUsageRequest
 */
 ...
 *
 * @generated from protobuf message k1s0.system.aigateway.v1.GetUsageResponse
 */
...
class CompleteRequest$Type extends MessageType<CompleteRequest> {
    constructor() {
        super("k1s0.system.aigateway.v1.CompleteRequest", [
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string model */ 1:
                    ...
                    break;
                case /* repeated k1s0.system.aigateway.v1.Message messages */ 2:
    ...
    internalBinaryWrite(message: CompleteRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* repeated k1s0.system.aigateway.v1.Message messages = 2; */
...
/**
 * @generated MessageType for protobuf message k1s0.system.aigateway.v1.CompleteRequest
 */
export const CompleteRequest = new CompleteRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Message$Type extends MessageType<Message> {
    constructor() {
        super("k1s0.system.aigateway.v1.Message", [
...
/**
 * @generated MessageType for protobuf message k1s0.system.aigateway.v1.Message
 */
export const Message = new Message$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CompleteResponse$Type extends MessageType<CompleteResponse> {
    constructor() {
        super("k1s0.system.aigateway.v1.CompleteResponse", [
...
/**
 * @generated MessageType for protobuf message k1s0.system.aigateway.v1.CompleteResponse
 */
...
class CompleteStreamRequest$Type extends MessageType<CompleteStreamRequest> {
    constructor() {
        super("k1s0.system.aigateway.v1.CompleteStreamRequest", [
            { no: 1, name: "model", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "messages", kind: "message", repeat: 2 /*RepeatType.UNPACKED*/, T: () => Message },
            { no: 3, name: "max_tokens", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 4, name: "temperature", kind: "scalar", T: 2 /*ScalarType.FLOAT*/ },
...
/**
 * @generated MessageType for protobuf message k1s0.system.aigateway.v1.CompleteStreamRequest
 */
...
class CompleteStreamResponse$Type extends MessageType<CompleteStreamResponse> {
    constructor() {
        super("k1s0.system.aigateway.v1.CompleteStreamResponse", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
/**
 * @generated MessageType for protobuf message k1s0.system.aigateway.v1.CompleteStreamResponse
 */
...
class EmbedRequest$Type extends MessageType<EmbedRequest> {
    constructor() {
        super("k1s0.system.aigateway.v1.EmbedRequest", [
            { no: 1, name: "model", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
/**
 * @generated MessageType for protobuf message k1s0.system.aigateway.v1.EmbedRequest
 */
export const EmbedRequest = new EmbedRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class EmbedResponse$Type extends MessageType<EmbedResponse> {
    constructor() {
        super("k1s0.system.aigateway.v1.EmbedResponse", [
            { no: 1, name: "model", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                case /* string model */ 1:
                    message.model = reader.string();
                    break;
                case /* repeated k1s0.system.aigateway.v1.Embedding embeddings */ 2:
    ...
    internalBinaryWrite(message: EmbedResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        if (message.model !== "")
            writer.tag(1, WireType.LengthDelimited).string(message.model);
        /* repeated k1s0.system.aigateway.v1.Embedding embeddings = 2; */
...
/**
 * @generated MessageType for protobuf message k1s0.system.aigateway.v1.EmbedResponse
 */
export const EmbedResponse = new EmbedResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Embedding$Type extends MessageType<Embedding> {
    constructor() {
        super("k1s0.system.aigateway.v1.Embedding", [
...
/**
 * @generated MessageType for protobuf message k1s0.system.aigateway.v1.Embedding
 */
export const Embedding = new Embedding$Type();
// @generated message type with reflection information, may provide speed optimized methods
class AiModel$Type extends MessageType<AiModel> {
    constructor() {
        super("k1s0.system.aigateway.v1.AiModel", [
            { no: 1, name: "id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
/**
 * @generated MessageType for protobuf message k1s0.system.aigateway.v1.AiModel
 */
export const AiModel = new AiModel$Type();
// @generated message type with reflection information, may provide speed optimized methods
class ListModelsRequest$Type extends MessageType<ListModelsRequest> {
    constructor() {
        super("k1s0.system.aigateway.v1.ListModelsRequest", [
...
/**
 * @generated MessageType for protobuf message k1s0.system.aigateway.v1.ListModelsRequest
 */
...
class ListModelsResponse$Type extends MessageType<ListModelsResponse> {
    constructor() {
        super("k1s0.system.aigateway.v1.ListModelsResponse", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ListModelsResponse): ListModelsResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated k1s0.system.aigateway.v1.AiModel models */ 1:
    ...
    internalBinaryWrite(message: ListModelsResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated k1s0.system.aigateway.v1.AiModel models = 1; */
...
/**
 * @generated MessageType for protobuf message k1s0.system.aigateway.v1.ListModelsResponse
 */
...
class GetUsageRequest$Type extends MessageType<GetUsageRequest> {
    constructor() {
        super("k1s0.system.aigateway.v1.GetUsageRequest", [
...
/**
 * @generated MessageType for protobuf message k1s0.system.aigateway.v1.GetUsageRequest
 */
export const GetUsageRequest = new GetUsageRequest$Type();
// @generated message type with reflection information, may provide speed optimized methods
class GetUsageResponse$Type extends MessageType<GetUsageResponse> {
    constructor() {
        super("k1s0.system.aigateway.v1.GetUsageResponse", [
            { no: 1, name: "tenant_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
/**
 * @generated MessageType for protobuf message k1s0.system.aigateway.v1.GetUsageResponse
 */
export const GetUsageResponse = new GetUsageResponse$Type();
/**
 * @generated ServiceType for protobuf service k1s0.system.aigateway.v1.AiGatewayService
 */
export const AiGatewayService = new ServiceType("k1s0.system.aigateway.v1.AiGatewayService", [
