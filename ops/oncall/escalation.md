...
> 起動条件: [`runbooks/incidents/severity-decision-tree.md`](../runbooks/incidents/severity-decision-tree.md) で **SEV1** が確定した直後に必ず起動する。
...
| 機関 | 条件 |
|------|------|
| 個人情報保護委員会 | PII 漏えい確定後 72h 以内（速報）— [RB-COMP-002 参照](../runbooks/incidents/pii-regulatory-disclosure.md) |
...
- 関連 Runbook:
  - [`runbooks/incidents/severity-decision-tree.md`](../runbooks/incidents/severity-decision-tree.md)
  - [`runbooks/incidents/pii-regulatory-disclosure.md`](../runbooks/incidents/pii-regulatory-disclosure.md)
  - [`runbooks/incidents/legal-disclosure.md`](../runbooks/incidents/legal-disclosure.md)
