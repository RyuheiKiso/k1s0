...
_rust-skip := "CLI/Cargo.toml|CLI/crates/k1s0-gui/Cargo.toml|regions/system/server/rust/ai-agent/Cargo.toml|regions/system/server/rust/ai-gateway/Cargo.toml"
...
lint-rust:
    ...
    for manifest in "${manifests[@]}"; do
        case "$manifest" in
            CLI/Cargo.toml|CLI/crates/k1s0-gui/Cargo.toml|regions/system/server/rust/ai-agent/Cargo.toml|regions/system/server/rust/ai-gateway/Cargo.toml) continue ;;
        esac
