...
You are investigating a project with two main components:
...
- **rust-dev**: For Rust implementation tasks
- **go-dev**: For Go implementation tasks
- **frontend-dev**: For frontend changes
- **lint-quality**: For code quality improvements
