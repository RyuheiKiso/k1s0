...
├── design/                 # Design documents (cli.md, generator.md, lint.md, framework.md, template.md)
├── conventions/            # Development conventions (service-structure.md, config-and-secrets.md, api-contracts.md, observability.md, error-handling.md, versioning.md)
