module github.com/RyuheiKiso/k1s0/framework/backend/go/k1s0-consensus
...
replace (
	...
	github.com/RyuheiKiso/k1s0/framework/backend/go/k1s0-db => ../k1s0-db
	github.com/RyuheiKiso/k1s0/framework/backend/go/k1s0-domain-event => ../k1s0-domain-event
