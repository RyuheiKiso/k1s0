...
/// Deep merge two maps
Map<String, dynamic> deepMergeConfig(
...
Map<String, dynamic> mergeAllConfigs(
  ...
  for (var i = 1; i < configs.length; i++) {
    result = deepMergeConfig(result, configs[i], listStrategy: listStrategy);
  }
...
Map<String, dynamic> mergeEnvironmentConfigMaps(
  ...
  return mergeAllConfigs(configs);
}
...
class ConfigMerger {
  ...
  static Map<String, dynamic> deepMerge(
    ...
    MergeStrategy listStrategy = MergeStrategy.replace,
      ...
      deepMergeConfig(base, override, listStrategy: listStrategy);
  ...
  static Map<String, dynamic> mergeAll(
    ...
    MergeStrategy listStrategy = MergeStrategy.replace,
      ...
      mergeAllConfigs(configs, listStrategy: listStrategy);
  ...
  static Map<String, dynamic> mergeEnvironmentConfig(
    ...
    Map<String, dynamic>? envConfig,
      ...
      mergeEnvironmentConfigMaps(defaultConfig, envConfig);
}
