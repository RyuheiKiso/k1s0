...
const (
	DecisionService_PlaceholderCall_FullMethodName = "/k1s0.tier1.decision.v1.DecisionService/PlaceholderCall"
)
...
func (c *decisionServiceClient) PlaceholderCall(ctx context.Context, in *PlaceholderCallRequest, opts ...grpc.CallOption) (*PlaceholderCallResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(PlaceholderCallResponse)
	err := c.cc.Invoke(ctx, DecisionService_PlaceholderCall_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedDecisionServiceServer) PlaceholderCall(context.Context, *PlaceholderCallRequest) (*PlaceholderCallResponse, error) {
...
func _DecisionService_PlaceholderCall_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(PlaceholderCallRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DecisionServiceServer).PlaceholderCall(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: DecisionService_PlaceholderCall_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DecisionServiceServer).PlaceholderCall(ctx, req.(*PlaceholderCallRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _DecisionService_PlaceholderCall_Handler,
		},
	},
