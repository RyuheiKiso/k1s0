...
/**
 * Describes the file k1s0/tier1/common/v1/common.proto.
 */
export const file_k1s0_tier1_common_v1_common: GenFile = /*@__PURE__*/
  fileDesc("");
 ...
 */
export type TenantContext = Message<"k1s0.tier1.common.v1.TenantContext"> & {
  /**
 ...
 */
export type ErrorDetail = Message<"k1s0.tier1.common.v1.ErrorDetail"> & {
  /**
...
/**
 * Describes the enum k1s0.tier1.common.v1.K1s0ErrorCategory.
 */
export const K1s0ErrorCategorySchema: GenEnum<K1s0ErrorCategory> = /*@__PURE__*/
  enumDesc(file_k1s0_tier1_common_v1_common, 0);
