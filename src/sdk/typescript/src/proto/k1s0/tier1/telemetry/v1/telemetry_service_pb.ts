 ...
 */
export class EmitMetricRequest extends Message<EmitMetricRequest> {
  /**
   * メトリクス列
   *
 ...
 */
export class EmitMetricResponse extends Message<EmitMetricResponse> {
 ...
 */
export class EmitSpanRequest extends Message<EmitSpanRequest> {
  /**
   * Span 列
   *
 ...
 */
export class EmitSpanResponse extends Message<EmitSpanResponse> {
