...
pub fn router() -> Router {
    ...
    // proto SoT: src/tier1/schema/bidi/tier1/bidi/v1/service.proto §package = tier1.bidi.v1
    // フルメソッド名は service.proto の package + service name + method name から構成する
    Router::new()
        // gRPC bidi streaming エンドポイントを登録する（POST / any）
        // gRPC フルメソッド名: "/{package}.{ServiceName}/{MethodName}" 形式
        // proto SoT: src/tier1/schema/bidi/tier1/bidi/v1/service.proto §package = tier1.bidi.v1
        // BidiService_OpenBidiStream_FullMethodName: tonic codegen が生成する定数と等価
        .route(
