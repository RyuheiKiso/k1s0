...
// パッケージ名: keyhandle（tier1 Library の Rule Engine API を提供する）
package keyhandle
...
type CachedRuleEngineClient interface {
	...
	EvaluateCached(ctx context.Context, path PolicyPath, input PolicyInput, cacheKey string, ttl *CacheTTL) (*PolicyResult, error)
