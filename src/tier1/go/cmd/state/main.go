...
// 関連 ID: IMP-DIR-002 / IMP-BUILD-002 / FR-T1-STATE / FR-T1-PUBSUB / ADR-TIER1-001 / ADR-TIER1-003
//
// 担当 API（docs 正典）:
...
//
// 未実装（plan 04-02 〜 04-05 で追加）:
//   - StateService / PubSubService ハンドラ実装
//   - Dapr Go SDK 経由の State / PubSub building block 接続
