...
module "keycloak" {
  ...
  react_spa_redirect_uris = ["https://app.k1s0.example.com/*"]
  react_spa_web_origins   = ["https://app.k1s0.example.com"]
  bff_redirect_uris       = ["https://api.k1s0.example.com/callback"]
}
