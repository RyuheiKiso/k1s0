...
const scenarios = [
  {
    ...
    desc: "Flagger baseline, healthy mesh traffic",
    group: "traffic",
    tab: "kiali",
  },
  {
    id: "canary",
    label: "Auto Canary Promote",
    desc: "Flagger shifts traffic in 20% steps",
    group: "traffic",
    tab: "kiali",
  },
  {
    id: "rollback",
    label: "Auto Canary Rollback",
    desc: "Flagger rolls back on 503 and latency",
    group: "traffic",
    tab: "grafana",
  },
  {
    id: "fault",
    label: "Scheduled Fault Test",
    desc: "CronJob template creates a 60s fault window",
    group: "traffic",
    tab: "grafana",
  },
  {
