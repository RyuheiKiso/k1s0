...
pub(super) const KIND_LABELS: &[&str] = &["サーバー", "クライアント", "ライブラリ", "データベース"];
pub(super) const ALL_KINDS: &[Kind] = &[Kind::Server, Kind::Client, Kind::Library, Kind::Database];
...
pub(super) const API_LABELS: &[&str] = &["REST (OpenAPI)", "gRPC (protobuf)", "GraphQL"];
pub(super) const ALL_API_STYLES: &[ApiStyle] = &[ApiStyle::Rest, ApiStyle::Grpc, ApiStyle::GraphQL];
...
pub(super) const RDBMS_LABELS: &[&str] = &["PostgreSQL", "MySQL", "SQLite"];
pub(super) const ALL_RDBMS: &[Rdbms] = &[Rdbms::PostgreSQL, Rdbms::MySQL, Rdbms::SQLite];
